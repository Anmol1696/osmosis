...
type QueryYml struct {
	...
	// Path to client folder e.g. "github.com/Anmol1696/osmosis/v11/x/twap/client"
...
type Keeper struct {
	// e.g. github.com/Anmol1696/osmosis/v11/x/twap
...
// input is of form github.com/Anmol1696/osmosis/vXX/{PATH}
// returns PATH
